    ...
    <div id="home">
        <div class="topnav ">
            ...
            <div class="topnav-right responsive_nav" id="myTopnav">
                ...
                <a href="{{ url('locale/en') }}" style="margin-right: 0"><img
                        src="{{ asset('img/flagEng.png') }}" width="30px" height="30px">Eng</a>
                <a href="{{ url('locale/mm') }}" style="margin-right: 0"><img
                        src="{{ asset('img/flagMyanmar.png') }}" width="30px" height="30px">မြန်မာ
                    &nbsp;</a>
        ...
        <div class="content">
            <div class="content_about" id="content_about">
                ...
                <div class="inner">
                    ...
                    <!-- 	Disregard --><a style="position: fixed; bottom: 10px; right: 10px;color:#CCC"
                        href="https://plus.google.com/111052275277622928148?rel=me">Google+</a>
                    <p class="txt_about">
                        {{ __('welcome.about1') }}<br>{{ __('welcome.about2') }}<br>{{ __('welcome.about3') }}
                    </p>
                ...
                <div class="contact inner">
                    <div class="address">
                        ...
                        <div class="contact_box">
                            <p>{{ __('common.address1') }}<br>{{ __('common.address2') }}
                            </p>
                        </div>
                    </div>
                    <div class="phone">
            ...
            <div class="content_terms" id="content_terms">
                ...
                <div class="inner">
                    <p class="txt_terms">
                        {{ __('term_condition.paragraph1') }}<br>{{ __('term_condition.paragraph2') }}
                    </p>
        ...
        <footer>
            ...
            <div class="footer_menu">
                <a href="#">{{ __('common.news') }}</a><a
                    href="#content_about">{{ __('common.about') }}</a><a
                    href="#content_contact">{{ __('common.contact') }}</a><a
                    href="#content_terms">{{ __('common.terms_and_conditions') }}</a>
            </div>
            <p class="txt_copyright">2019© All Rights Reserved. EasyDonateMyanmar.com</p>
            <div class="social_menu">
                <a
                    href="https://www.facebook.com/လႉမယ္လြယ္လြယ္-107640630579396/?eid=ARC2LdA06F1AyHQq1mdN21B5l-UqxelPvIbCylgzcBKfmwfx4Mbyc-I0Z0qL0tuLCr9EkYdW9WAS7nPI"><img
                        src="img/icon_fb.png" alt="" width="42" height="42"></a>
                <a href="https://twitter.com/DonateEasy"><img src="img/icon_twitter.png" alt="" width="42"
                        height="42"></a>
