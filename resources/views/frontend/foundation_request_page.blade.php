                    ...
                    <div class="card shadow card2 mb-4 promoting-card" id="peopleInNeedCard">
                        ...
                        <div class="card-body people_card text-center">
                            <div class="collapse-content">
                                <p class="mt-3"><img src="{{asset('img/house.svg')}}" width="5%"> &nbsp;<strong> Location :</strong> &nbsp;{{$user_posts->location}}</p>
                                <p><img src="{{asset('img/idea.svg')}}" width="5%"> &nbsp;<strong>  Item Requested :</strong> &nbsp;{{$user_posts->items_requested}}</p>
                                <p><img src="{{asset('img/rich.svg')}}" width="5%"> &nbsp;<strong>  Estimated Costs :</strong> &nbsp;{{$user_posts->cost}}</p>
                                <p><img src="{{asset('img/star.svg')}}" width="5%"> <strong> Significance of the project :</strong> &nbsp;{{$user_posts->significance}}</p>
                                <p><img src="{{asset('img/phone.svg')}}" width="5%">&nbsp;<strong>  Phone :</strong> &nbsp;{{$user_posts->phone}}</p>
                                <p><img src="{{asset('img/edit.svg')}}" width="5%">&nbsp;<strong>  remark :</strong> &nbsp;{{$user_posts->remark}}</p>
                            </div>
                    ...
                    @foreach($donateForm as $donateForms)
                        @if($donateForms->donate_foundation==Auth::user()->id)
                            <div class="card donor_card card1 post_card" style="margin-bottom: 30px; border-radius: 10px;">
                                <div class="card-header" >
                                <img src="{{asset('img/donate.png')}}" style="width: 50px;height: 50px;" class="rounded-circle" >  Donor
