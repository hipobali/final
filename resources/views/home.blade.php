...
@section('content')
    <div id="news">
                                ...
                                <div class="urgent_txt">
                                    ...
                                    <div>
                                        ...
                                        <div class="detail_btn">
                                            <a class="detail_link" data-toggle="modal" data-target="#exampleModala{{$foundation_posts->id}}" href="#" style="text-decoration: none" >{{__('common.detail')}} </a>
                                        </div>

                                        <div class="modal fade" id="exampleModala{{$foundation_posts->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        ...
                        @foreach($foundation_post as $foundation_posts)
                            <div class="donation_data ">
                                ...
                                <div class="donation_data_ttl">
                                    <a data-toggle="modal" data-target="#exampleModals{{$foundation_posts->foundation_id}}">
                                        <img  src="{{url('uploads/'.$foundation_posts->foundation->foundation_profile)}}" width="38" height="38">
                                    </a>
                                    <div class="modal fade" id="exampleModals{{$foundation_posts->foundation_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                ...
                                <div class="detail_btn">
                                    <a class="detail_link " href="" data-toggle="modal" data-target="#exampleModall{{$foundation_posts->id}}" style="text-decoration: none">{{(__('common.detail'))}}</a>
                                </div>
        ...
        <footer>
            ...
            <a style="text-decoration:none;" href="{{url('home')}}">{{__('common.home')}}</a><a style="text-decoration:none;" href="{{url('User/about_us')}}">{{__('common.about')}}</a><a style="text-decoration:none;" href="{{url('User/ContactUs')}}">{{__('common.contact')}}</a><a style="text-decoration:none;" href="{{url('User/termsandconditions')}}">{{__('common.terms_and_conditions')}}</a>
            </div>
