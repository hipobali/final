        ...
        <div class="row " style="margin-top:50px;">
            <div class="col-md-6 text-center left-side">
                <div class="text_point ">
                    ...
                    <h3 style="color: hsl(35,100%,50%)">&nbsp;{{ __('user.login_to_account') }}&nbsp;
                    </h3>
                ...
                <img class="img-fluid" src="{{ asset('img/community2.png') }}" width="200px"
                ...
                <div class="card shadow">
                    <form method="post" action="{{ url('people/login') }}">
                        <div class="card-header text-center">
                            <img src="{{ asset('img/logo.png') }}" alt="Easy Donate Logo"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group md-form"
                                ...
                                <i class="fa fa-envelope"></i> <label for="email">&nbsp
                            ...
                            <div class="form-group"
                                ...
                                <i class="fas fa-lock"></i><label for="password">&nbsp
                                    {{ __('user.password') }}</label>
                                <div class="input-group" id="show_hide_password">
                                    <input type="password" id="password" name="password" class="form-control"
                                        placeholder={{ __('user.enter_pw') }}>
                            ...
                            <div class="form-group row">
                                <div class="col-6">
                                    <a href="{{ url('donor/home') }}"
                                        class="btn btn-light form-control btnCancel">{{ __('user.login_cancel') }}</a>
                                </div>
                                <div class="col-6">
                                    <button type="submit"
                                        class="btn btn-light  form-control btnSave">{{ __('user.login') }}</button>
                                </div>
                            </div>
                            <div class="form-group text-center">
                                {{ __('user.ask_account') }} <a id="login"
                                    href="{{ url('people/register/view') }}"
                                    style="text-decoration: none">{{ __('user.register') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
